class Programmer():
    Type="programmer"
    def _init_(self,name : str ,programmer_id :int ,languge :str ):
        self.__name=name
    ...
    def write_info(self):
        ...
        try:
            file.writelines(f"{self._name}\t\t {self.programmer_id}\t\t {self._languge}\n")
        except:
...
class Student(Programmer):
    Type='student'
    def _init_(self, name: str, student_id: int, languge: str):
        super()._init_(name, student_id, languge)
